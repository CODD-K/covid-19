...
-   **കഴിഞ്ഞ ഏതാനും മാസങ്ങൾ** (എപിഡെമിയോളജി ബാലപാഠങ്ങൾ, SEIR മോഡൽ, R & R<sub>0</sub>\)
...
അപ്പോൾ, നമുക്ക് വളരെ, *വളരെ* ലളിതമായ "എപിഡെമിക് ഫ്ലൈറ്റ് സിമുലേറ്റർ" നിർമ്മിക്കാം! ഈ സിമുലേഷനിൽ രോഗബാധിതരായ ആളുകൾ <icon i></icon> രോഗബാധയേൽക്കാൻ സാധ്യതയുള്ളവരെ <icon s></icon> കൂടെ കൂട്ടി രോഗബാധിതരുടെ <icon i></icon> എണ്ണം വർദ്ധിപ്പിക്കും:

<img class="lozad" data-src="pics/spread-ml.png" />

ഒരു കോവിഡ്-19 വ്യാപനത്തിന്റെ *ആരംഭത്തിൽ*, വൈറസ് ഒരു <icon i></icon> നിന്നും <icon s></icon> ആളിലേക്ക് *ശരാശരി* ഓരോ 4 ദിവസത്തിലും ചാടുമെന്ന് കരുതപ്പെടുന്നു.[^serial_interval](പക്ഷേ ഇതിൽ വലിയ വ്യതിയാനങ്ങളുണ്ടാവാമെന്ന കാര്യം ഓർമ്മിക്കുക)
...
*മറ്റെല്ലാം ഒഴിവാക്കി,* ഒരു സമൂഹത്തിലെ <icon i></icon> 0.001% ശതമാനത്തിൽ തുടങ്ങി, ഓരോ "നാലു ദിവസത്തിലും ഇരട്ടിയാകും" എന്ന് കരുതി സിമുലേറ്റ് ചെയ്താൽ, എന്ത് സംഭവിക്കും?

**സിമുലേഷൻ പ്ലേ ചെയ്യാൻ "തുടങ്ങുക" എന്ന ബട്ടൺ അമർത്തൂ! ഇത് നിങ്ങൾക്ക് സാഹചര്യങ്ങൾ മാറ്റി എത്ര തവണ വേണമെങ്കിലും പ്ലേ ചെയ്ത് നോക്കാം:** (അല്പം സാങ്കേതിക മുന്നറിയിപ്പുകൾ: [^caveats])
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-1" width="800" height="540"></iframe>
</div>
...
<img class="lozad" data-src="pics/exponential-ml.png" />
...
<img class="lozad" data-src="pics/susceptibles-ml.png" />

കൂടുതൽ രോഗികൾ <span class="nowrap"><icon i></icon></span> ഉള്ളപ്പോൾ, കൂടുതൽ വേഗത്തിൽ രോഗം വരാൻ സാധ്യതയുള്ളവർ <span class="nowrap"><icon s></icon></span> രോഗികൾ <span class="nowrap"><icon i></icon></span> ആയി മാറും **പക്ഷെ സാധ്യതയുള്ളവർ <span class="nowrap"><icon s></icon></span> എത്ര കുറവാണോ, അത്ര *സാവധാനത്തിലെ* അവർ <span class="nowrap"><icon s></icon></span> രോഗികൾ <span class="nowrap"><icon i></icon></span> ആകുകയുള്ളു**

ഇതെങ്ങിനെയാണ് ഒരു മഹമാരിയുടെ വളർച്ചയെ തടയുന്നത്? നമുക്ക് നോക്കാം:<sub>

<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-2" width="800" height="540"></iframe>
</div>
...
പക്ഷെ, ഈ സിമുലേഷനും തെറ്റാണ്. രോഗബാധയുള്ള ആളുകൾ <icon i></icon> ക്രമേണ രോഗം പരത്തുന്ന അവസ്ഥയിൽ നിന്നും പിന്മാറും എന്ന കാര്യം നമ്മൾ ഇതിൽ വിട്ടുകളയുന്നു. അവർ പല രീതിയിൽ രോഗം പരത്തുന്ന അവസ്ഥയിൽ നിന്ന് ഒഴിവാകും:
    - സൗഖ്യം പ്രാപിക്കുക വഴി,
    - ശ്വാസകോശത്തിനു തകരാറോടെ "സുഖമാകുക" വഴി,
    - മരണപ്പെടുക, എന്നിങ്ങനെ.

കാര്യങ്ങൾ അല്പം ലളിതമാക്കാൻ, എല്ലാ രോഗികളും <icon i></icon> സുഖമാകുമെന്ന് <icon r></icon> അനുമാനിക്കുക. (യഥാർത്ഥത്തിൽ കുറച്ച് പേർ മരണപ്പെടും.) സാധ്യതയുള്ളവർക്ക് <span class="nowrap"><icon s></icon></span> ഭാവിയിൽ രോഗം ബാധിക്കില്ലെന്നും നമുക്ക് അനുമാനിക്കാം — *തൽക്കാലത്തേക്ക്!* — അതായത് അവർക്ക് ശേഷിക്കുന്ന ജീവിതകാലം മുഴുവൻ രോഗം ബാധിക്കില്ല. 

കോവിഡ്-19ന്റെ കാര്യത്തിൽ, ഒരാൾ *ശരാശരി* 10 ദിവസത്തേക്ക് <icon i></icon> അസുഖമുള്ളയാളായിരിക്കുമെന്ന് കണക്കാക്കപ്പെടുന്നു.[^infectiousness] അതിന്റെയർത്ഥം ചിലയാളുകൾ 10 ദിവസങ്ങൾക്കു മുന്നെയും, ചിലർ 10 ദിവസങ്ങൾക്ക് ശേഷമോ സുഖപ്പെടുമെന്നതാണ്. 

**സിമുലേഷൻ 100% രോഗികളുമായി <span class="nowrap"><icon i></icon></span> *തുടങ്ങിയാൽ* ഇങ്ങിനെയാണത് കാണപ്പെടുക**:
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-3" width="800" height="540"></iframe>
</div>
...
<img class="lozad" data-src="pics/graphs_q-ml.png" />
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-4" width="800" height="540"></iframe>
</div>
...
ഇതാണ് **എസ്ഐആർ മാതൃക (SIR Model**,[^sir_model] **S**usceptible <icon s></icon> (രോഗം ബാധിക്കാനിടയുള്ളവർ), **I**nfectious <icon i></icon> (രോഗമുള്ളവർ), **R**ecovered <icon r></icon> (സുഖമായവർ). 
...
<img class="lozad" data-src="pics/sir-ml.png" />
...
നമുക്ക് ഇതിലേക്ക് അല്പം വൈവിധ്യം വരുത്തിയാലോ: ഒരു <icon s></icon> ഒരു <icon i></icon> ആകണമെങ്കിൽ, അയാൾ ആദ്യം <icon e></icon> സ്വീകർത്താവാകണം. ഈ സാഹചര്യത്തിൽ അവർക്ക് വൈറസുണ്ട്, എന്നാൽ അത് മറ്റുള്ളവർക്ക് പകർന്ന് നൽകാൻ കഴിയില്ല — രോഗിയാണ്, എന്നാൽ രോഗവാഹിയല്ല.

<img class="lozad" data-src="pics/seir-ml.png" /> (ഈ വകഭേദത്തെയാണ് **എസ്ഇഐആർ മാതൃക (SEIR Model)**[^seir] എന്ന് വിളിക്കുന്നത്, ഇതിൽ "E" "സ്വീകർത്താവിനെ" <icon e></icon> സൂചിപ്പിക്കുന്നു. ഇത് സാധാരണ നമ്മൾ കരുതുന്ന വൈറസുണ്ടാവാം, ഉണ്ടാവില്ല എന്ന തരം "സമ്പർക്കമുള്ളവർ" അല്ല. സാങ്കേതികമായി, "സ്വീകർത്താവ്" എന്നാൽ വൈറസ് ശരീരത്തിലെത്തിയയാൾ എന്ന് തന്നെയാണ്. ശാസ്ത്ര സങ്കല്പങ്ങൾ ചിലപ്പോൾ ഇങ്ങിനെ വിചിത്രമാണ്.)
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-5" width="800" height="540"></iframe>
</div>

വലിയ വ്യത്യാസമില്ല! എത്ര നാൾ ഒരാൾ <icon e></icon> സ്വീകർത്താവായി തുടരും എന്നത് <icon e></icon>ഉം-<icon i></icon>ഉം തമ്മിലുള്ള അനുപാതം മാറ്റുന്നു, കൂടാതെ നിലവിലുള്ള കേസുകൾ എപ്പോൾ അതിന്റെ *ഉന്നതിയിൽ* എത്തുമെന്നതും... എന്നാൽ ആ കൊടുമുടിയുടെ *ഉയരവും*, അവസാനം വരെ ആകെയുള്ള രോഗികളുടെ എണ്ണവും, മാറ്റമില്ലാതെ തുടരുന്നു.

എന്തു കൊണ്ടാണത്? കാരണം എപിഡെമിയോളജി ബാലപാഠങ്ങളിലെ ഏറ്റവും *പ്രധാനപ്പെട്ട* ആശയം എന്താണെന്ന് വച്ചാൽ:

<img class="lozad" data-src="pics/r-ml.png" /> 
...
<img class="lozad" data-src="pics/r2-ml.png" /> 

**R**ന്റെ വില ഒരു പകർച്ചവ്യാധിക്കിടെ, നമുക്ക് രോഗ പ്രതിരോധശേഷി ലഭിക്കുന്നതിലൂടെയും നമ്മുടെ ഇടപെടലുകളിലൂടെയും, മാറിക്കൊണ്ടേയിരിക്കും.

**R<sub>0</sub>** (ആർ-നോട്ട് എന്നുച്ചരിക്കും) എന്നാൽ ഒരു വ്യാധിയുടെ തുടക്കത്തിൽ, പ്രതിരോധശേഷിയോ മറ്റിടപെടലുകളോ ഇല്ലാത്ത ഘട്ടത്തിലുള്ള R<sub>0</sub> ഒരു വൈറസിന്റെ ശക്തിയെന്തെന്ന സൂചന നൽകുന്ന സംഖ്യയാണ്, പക്ഷേ ഇത് ഓരോ സ്ഥലങ്ങളിലും വ്യത്യസ്തമായിരിക്കും. ഉദാഹരണത്തിന്, ജനസാന്ദ്രത കൂടിയ നഗരങ്ങളിൽ നിന്ന് വ്യത്യസ്തമായിരിക്കും R<sub>0</sub> ഗ്രാമങ്ങളിൽ.

(മിക്ക വാർത്താ ലേഖനങ്ങളും – ചില ഗവേഷണ പ്രബന്ധങ്ങൾ പോലും! – R-ഉം R<sub>0</sub>-ഉം തമ്മിൽ കൂട്ടിക്കുഴയ്ക്കും. വീണ്ടൂം, ശാസ്ത്രം അല്പം ദുരൂഹമാണ്)

"സീസണുകളിൽ" ഉണ്ടാവുന്ന ഫ്ലൂ പനിയുടെ R<sub>0</sub> ഏകദേശം 1.28[^r0_flu] ആണ്. അതായത്, ഒരു ഫ്ലൂ പകർച്ചപ്പനി പൊട്ടിപ്പുറപ്പെടുന്ന ഘട്ടത്തിൽ, ഒരു <icon i></icon> *ശരാശരി* 1.28 ആളുകൾക്ക് രോഗം പകർന്നു കൊടുക്കും. (ഇതൊരു പൂർണ്ണ സംഖ്യയല്ലാത്തതിനാൽ വിചിത്രമായി തോന്നുന്നുണ്ടെങ്കിൽ, ഓർക്കുക ഒരു അമ്മയ്ക്ക് "ശരാശരി" 2.4 കുട്ടികളുണ്ടാവും. ഇതിന്റെ അർത്ഥം അരക്കുട്ടിയുണ്ടാവുമെന്നല്ല - പത്ത് അമ്മമാരുള്ള ഒരു സ്ഥലത്ത് ശരാശരി 24 കുട്ടികളുണ്ടാവാം). 
...
നമ്മുടെ സിമുലേഷനുകളിൽ – *തുടക്കത്തിലും, ശരാശരിയിലും* – 10 ദിവസ കാലയളവിൽ ഒരു <icon i></icon> ഓരോ 4 ദിവസത്തിലും മറ്റൊരാൾക്ക് രോഗം പകരുന്നു. "10 ദിവസങ്ങളിൽ" "4 ദിവസങ്ങൾ" എന്നത് രണ്ടര ഇരട്ടിയാണ്. അതായത് – *തുടക്കത്തിൽ, ശരാശരി* – ഓരോ <icon i></icon>-ഉം 2.5 ആളുകൾക്ക് രോഗം പകർന്നു കൊടുക്കുന്നു. അതിനാൽ, R<sub>0</sub> = 2.5. (caveats:[^r0_caveats_sim])

[^r0_caveats_sim]: ഇതിൽ ഒരാൾ തനിക്ക് "രോഗം പകർന്ന് കൊടുക്കാൻ കഴിയുന്ന കാലം" മുഴുവൻ ഒരേ തീവ്രതയോടെ അത് ചെയ്യുന്നു എന്ന് നമ്മൾ അനുമാനിക്കുന്നു. വീണ്ടൂം, നമ്മൾ, എളുപ്പം മനസ്സിലാക്കാനായി കാര്യം അല്പം ലളിതമാക്കി. 
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-6a&format=calc" width="285" height="255"></iframe>
</div>

പക്ഷെ ഓർമ്മിക്കുക, കുറച്ച് <span class="nowrap"><icon s></icon>-കൾ</span> ഉള്ളപ്പോൾ, *കുറഞ്ഞ* <span class="nowrap"><icon s></icon>-കൾ</span> വേഗതയിലേ <span class="nowrap"><icon i></icon>-കൾ</span> ആകൂ. *ഇപ്പോഴത്തെ* റിപ്രൊഡക്ഷൻ നമ്പർ (R) *തുടക്കത്തിലെ* റിപ്രൊഡക്ഷൻ നമ്പരിനെ (R<sub>0</sub>) മാത്രമല്ല, *കൂടാതെ* രോഗം ബാധിക്കാനിടയില്ലാത്ത എത്രയാളുകൾ ഉണ്ടെന്നതിക്കൂടി <icon s></icon> ആശ്രയിച്ചിരിക്കുന്നു. (ഉദാഹരണത്തിന്, സൗഖ്യം പ്രാപിക്കുന്നവർ, സ്വാഭാവിക പ്രതിരോധശേഷി ലഭിക്കുന്നവർ, എന്നിങ്ങനെയുള്ളവരുടെ എണ്ണം.)

<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-6b&format=calc" width="285" height="390"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=epi-7" width="800" height="540"></iframe>
</div>
...
<img class="lozad" data-src="pics/r3-ml.png" /> 

**ഇതിന്റെയർത്ഥം: കോവിഡ്-19നെ തടഞ്ഞു നിർത്താൻ നമ്മൾ എല്ലാ രോഗ പകർച്ചയേയുമെന്നല്ല, അതിനടുത്ത് എണ്ണത്തെ പോലും തടയേണ്ടതില്ല!**

ഇതൊരു വിരോധാഭാസമായി തോന്നാം. കോവിഡ്-19 വളരെയധികം പകരുന്ന ഒന്നാണ്, എന്നാൽ അതിനെ തടഞ്ഞു നിർത്താൻ, നമുക്ക് 60%-ലേറെ രോഗപ്പകർച്ചകൾ "മാത്രം" തടഞ്ഞാൽ മതിയാകും. 60%?! ഒരു സ്കൂൾ പരീക്ഷയ്ക്കുള്ള ഗ്രേഡാണെങ്കിൽ, ഒരു D- ആണത്. പക്ഷെ R<sub>0</sub> = 2.5 ആയിരിക്കുമ്പോൾ, അതിന്റെ 61% തടഞ്ഞാൽ നമുക്ക് R = 0.975 എന്ന് ലഭിക്കും, അതായത് R < 1, വൈറസിനെ പിടിച്ച് കെട്ടി! (ശരിയായ ഫോർമുല:[^exact_formula])
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-1&format=lines" width="800" height="540"></iframe>
</div>
...
ഒരു 0.5% രോഗബാധിതർ മരണമടഞ്ഞാൽ പോലും[^ifr] – കൂടുതൽ ഐസിയുകൾ ലഭ്യമല്ല എന്ന ഊഹം വച്ച് – ഏകദേശം 30 കോടി ജനങ്ങളുള്ള അമേരിക്ക പോലുള്ള ഒരു രാജ്യത്ത്, 30 കോടിയുടെ 80 ശതമാനത്തിന്റെ 0.5% = 12 ലക്ഷം ആളുകൾ മരണമടയും... *നമ്മൾ ഒന്നും ചെയ്തില്ലെങ്കിൽ.*
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-2a&format=calc" width="285" height="260"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-2&format=lines" width="800" height="540"></iframe>
</div>

മൂന്ന് കുറിപ്പുകൾ:

1.  ഈ പ്രക്രിയ മൊത്തം കേസുകൾ *കുറയ്ക്കുന്നു*! **നമുക്ക് R < 1 എന്നായില്ലെങ്കിലും, ഹെർഡ് ഇമ്മ്യൂണിറ്റിക്ക് മുകളിലേക്കുള്ള കുതിപ്പിന്റെ തോത് കുറയ്ക്കുക വഴി, R കുറയ്ക്കുന്നത് ജീവനുകൾ രക്ഷിക്കും.** "കർവിനെ പരത്തുക" എന്നത് കേസുകൾ കുറയ്ക്കാതെ മൊത്തം കേസുകൾ പരത്തിയെടുക്കുന്നതാണെന്ന് നിരവധിയാളുകൾ കരുതുന്നുണ്ട്. *ഏതൊരു* എപിഡെമിയോളജി ബാലപാഠങ്ങളുടെ മോഡലിലും ഇത് അസംഭ്യവമാണ്. "80 ശതമാനന്തിൽ അധികം ആളുകൾ രോഗബാധിതരാകും" എന്ന മട്ടിലുള്ള വാർത്തകൾ ഒഴിവാക്കാനാവാത്തതിനാൽ, എന്ത് തന്നെ സംഭവിച്ചാലും മൊത്തം കേസുകൾ കുറയില്ല എന്ന് ചിലയാളുകൾ കരുതും. *!!!*
...
<img class="lozad" data-src="pics/mitigation_vs_suppression-ml.png" />
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-3&format=lines" width="800" height="540"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-4&format=lines" width="800" height="540"></iframe>
</div>
...
പക്ഷെ ഒന്ന് നിൽക്കൂ... തയ്‌വാനും ദക്ഷിണ കൊറിയയും *ഇപ്പോൾതന്നെ* കോവിഡ്-19-നെ പിടിച്ച് കെട്ടിയില്ലേ? 4 മാസത്തേക്ക്, നീണ്ട ലോക്ക്ഡൗണുകൽ *ഇല്ലാതെ തന്നെ*
...
തയ്‌വാനും കൊറിയയും എങ്ങിനെയാണ് കോവിഡ്-19നെ പിടിച്ച് നിർത്തിയതെന്നറിയാൻ, നമുക്ക് കോവിഡ്-19-ന്റെ നാൾവഴി അറിയേണ്ടതുണ്ട്[^timeline]:
...
<img class="lozad" data-src="pics/timeline1-ml.png" />
...
<img class="lozad" data-src="pics/timeline2-ml.png" />
...
<img class="lozad" data-src="pics/timeline3-ml.png" />

ഇതിനെയാണ് **കോണ്ടാക്ട് ട്രേസിങ്ങ്** എന്ന് വിളിക്കുന്നത്. ഇത് പഴയൊരു ആശയമാണ്, ഇബോള കാലത്ത് വളരെയധികം ഉപയോഗിച്ച ഒന്ന്[^ebola], ഇപ്പോൾ തയ്‌വാനും,ദക്ഷിണ കൊറിയയും കോവിഡ്-19 തടയുന്നതിന് സ്വീകരിച്ച പ്രധാന മാർഗ്ഗം ഇതാണ്!
...
<img class="lozad" data-src="pics/dp3t-ml.png" />
...
(രോഗലക്ഷണം വരുന്നതിനു മുന്നെയുള്ള പകർച്ചയും, "ശരിയായ" ലക്ഷണങ്ങളില്ലാത്തവയും - "ശരിയായ" ലക്ഷണങ്ങളുള്ളവയും തമ്മിലുള്ള ആശയക്കുഴപ്പത്തെക്കുറിച്ചുള്ള അടിക്കുറിപ്പ് അപൂർണ്ണമാണ്:[^rant])
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-4a&format=calc" width="285" height="340"></iframe>
</div>
...
രോഗം ബാധിക്കാനിടയുള്ള <span class="nowrap"><icon s></icon></span> ആളൂകളെ *ശരിയായ മാർഗ്ഗത്തിൽ* രോഗപ്രതിരോധശേഷി ഉള്ള <span class="nowrap"><icon r></icon>.</span> ആളുകളാക്കാൻ കഴിയുന്ന ഹെർഡ് ഇമ്മ്യൂണീറ്റി നൽകുന്ന ഒരു വാക്സിൻ ലഭിക്കുന്നതുവരെ നമ്മൾ R < 1 സൂക്ഷിക്കുന്നു:

<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-4b&format=calc" width="285" height="230"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-5&format=lines" width="800" height="540"></iframe>
</div>
...
R<sub>0</sub> നമ്മൾ വിചാരിച്ചതിലും വളരെ ഉയർന്നതാണെങ്കിൽ, മുകളിൽ പറഞ്ഞ ഇടപെടലുകൾ, നേരിയ ശാരീരിക അകലം സൂക്ഷിച്ചാൽ *പോലും*, R < 1 ലഭിക്കാൻ പര്യാപ്തമല്ലെങ്കിലോ?
...
നിങ്ങൾ പറഞ്ഞത് ശരിയാണ്. മാസ്കുകൾ ഒരാൾക്ക് അസുഖം വരുന്നത് തടയുന്നില്ല[^incoming]... അവ ഒരാൾ *മറ്റുള്ളവർക്ക്* അസുഖം നൽകുന്നതാണ് തടയുന്നത്.
...
<img class="lozad" data-src="pics/masks-ml.png" />
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-6a&format=calc" width="285" height="380"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-6b&format=calc" width="285" height="220"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=int-7&format=lines&height=620" width="800" height="620"></iframe>
</div>
...
തീർച്ചയായും, നിങ്ങളുടെ കൈകൾ ശുഷ്ക്കിച്ചതാകാം. എന്നാലും നിങ്ങൾക്ക് ഒരു കോമിക്സ് പുസ്തകശാലയിലേക്ക് സുഹൃത്തിനെ ക്ഷണിക്കാൻ കഴിയും!  ഏറ്റവും പുതിയ ഹോളിവുഡ് ബ്ലോക്ക്‌ബസ്റ്റർ ചിത്രം കാണുന്നതിന് നിങ്ങൾ സുഹൃത്തുക്കളുമായി പുറത്തുപോകും. നിങ്ങൾക്ക് ഒരു ലൈബ്രറിയിൽ ആളുകളെ നിരീക്ഷിക്കാം, *ജീവനോടെയിരിക്കുന്നുവെന്ന* ലളിതമായ കാര്യത്തേക്കുറിച്ച് ആളുകൾ സംസാരിക്കുന്നതിൽപോലും നിങ്ങൾ സന്തോഷം കണ്ടെത്തും.
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=yrs-1&format=lines&height=600" width="800" height="600"></iframe>
</div>

എക്‌സ്‌പോണൻഷ്യൽ ഡീകെയുടെ മടങ്ങിവരവ്!

ഇതാണ് **എസ്ഇഐആർഎസ് മാതൃക** (SEIRS model). അവസാനത്തെ "S" രോഗം വീണ്ടൂം പിടിപെടാൻ ഇടയുള്ളവരെ <icon s></icon> സൂചിപ്പിക്കുന്നു.

<img class="lozad" data-src="pics/seirs-ml.png" />
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=yrs-2&format=lines&height=600" width="800" height="600"></iframe>
</div>

മുമ്പത്തെ സിമുലേഷനുകളിൽ, നമുക്ക് ഐസിയു പരിധി കടക്കുന്ന *ഒരു* സ്പൈക്ക് മാത്രമേ ഉണ്ടായിരുന്നുള്ളൂ. ഇപ്പോൾ, നമുക്ക് <icon i></icon> നിരവധിയുണ്ട്, കേസുകൾ ഐസിയു ശേഷിയിൽ എത്തി *ശാശ്വതമായി* നിൽക്കുന്നു. (ഏത്, ഓർക്കുക, ഈ സിമുലേഷനുകൾക്കായി നമ്മളത് മൂന്നിരട്ടിയാക്കിയിരുന്നു)
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=yrs-3&format=lines&height=640" width="800" height="640"></iframe>
</div>

ഓ!,

വിധിവൈപരീത്യമെന്നപോലെ, വേനൽക്കാലം രോഗത്തിന്റെ കുതിപ്പിനെ മോശം അവസ്ഥയിലേക്കെത്തിക്കുകയും അവരെ ഒരു പതിവാക്കുകയും ചെയ്യുന്നു! വേനൽക്കാലം പുതിയ <span class="nowrap"><icon i></icon>കളെ</span> *കുറയ്ക്കുന്നതിനൊപ്പം,* പുതിയ <span class="nowrap"><icon r></icon>കളൂടെ</span> രോഗപ്രതിരോധ ശേഷിയും കുറയ്ക്കുന്നു. ഇതിനർത്ഥം വേനൽക്കാലത്ത് പ്രതിരോധശേഷി കുറയുകയും, ശൈത്യകാലത്ത് അതിനാൽ വലിയ വർദ്ധനവ് *സൃഷ്ടിക്കപ്പെടുകയും* ചെയ്യുന്നു.
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=yrs-4&format=lines" width="800" height="540"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=yrs-5&format=lines" width="800" height="540"></iframe>
</div>
...
<div class="sim">
        <iframe class="lozad" data-src="sim?stage=SB&format=sb" width="800" height="540"></iframe>
</div>
...
<img class="lozad" data-src="pics/plan-ml.png" />
...
[തിരുത്തലുകളും നിർദ്ദേശങ്ങളും പങ്കുവയ്ക്കൂ](https://bit.ly/2zf5qmB)
